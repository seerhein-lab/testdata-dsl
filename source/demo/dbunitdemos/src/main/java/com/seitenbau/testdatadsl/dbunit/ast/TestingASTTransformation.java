...
public class TestingASTTransformation implements ASTTransformation
{
  ...
  private void getColumns(Expression expression, List<ColumnElement> list)
  {
    if (expression instanceof BinaryExpression)
    {
      ...
      if (be.getOperation().getType() == Types.DOUBLE_PIPE || be.getOperation().getType() == Types.PIPE)
      {
  ...
  private void addVariableExpression(Expression expression, List<VariableElement> list)
  {
    if (expression instanceof BinaryExpression)
    {
