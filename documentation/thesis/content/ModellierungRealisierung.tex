...
\todo{Erklären, warum SB Testing DB eine gute Grundlage ist: Kompatibilität, Verbesserungen gegenüber DBUnit, ähnliche Ziele...}
...
\textit{SB Testing DB} stellt eine sinnvolle Grundlage für Erweiterungen und Verbesserung dar, da es die Modellierung und vor allem
auch die Änderung von DbUnit-DataSets vereinfacht. Aus einem domänenspezifischen
...
\textit{Apache License 2.0}. \cite{APACHE_LICENSE_2}

Die Auswirkungen auf die Architektur von Tests zeigt Abbildung \ref{img:architektur}. Der Test basiert auf 
...
\label{sec:modellierung:generatormodell}
  ...
  \todo{Einleiten, dass vor Allem Erweiterungen im Bereich der Beziehungen notwendig sind}
