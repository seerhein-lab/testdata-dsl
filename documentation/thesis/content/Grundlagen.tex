...
\label{sec:grundlagen:konventionen}
  ...
  \subsection{ER-Diagramme}
	...
	Alle in dieser Arbeit abgebildeten relationalen Datenbank-Diagramme verwenden einen einheitlichen Stil.
	Dieser basiert auf dem UML-Klassendiagramm.
...
\begin{figure}[H]
  \centering
	...
	\caption{UML-Klassendiagramm der STU-DataSet-Klassen}\label{img:sb_testing_classes}
\end{figure}
