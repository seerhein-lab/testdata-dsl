...
<dataset>
  ...
  <table name="LEHRVERANSTALTUNG">
	...
	Datasets in XML wachsen relativ in vertikaler Richtung und enthalten unter Umständen auch viel syntaktischen Overhead.
...
dataSet.addTable(lehrveranstaltung);
	...
	und umfangreiche Datensets werden schnell unübersichtlch. 
