...
\begin{itemize}
	...
	\item \textbf{Minimal Fixture}: Ein Fixture, das speziell für einen Test erstellt wurde und dessen Umfang auf
	  die für diesen Test notwendigen Daten reduziert ist, wird als Minimal Fixture bezeichnet. Aufgrund ihres
		...
		von Minimal Fixtures zu Leistungsvorteilen bei der Ausführung von Tests führen. \cite[302]{XUNIT_TEST_PATTERNS}
\end{itemize}


	\subsection{Datenbank-Tests}

	Ein übliches Muster, Systeme in Verbindung mit Datenbanken zu testen, ist \textit{Back Door Manipulation}. Dieses Muster
	besteht aus vier Schritten. Im ersten Schritt, dem \textit{Setup}, wird die Datenbank über direkten Zugriff, vorbei am
	zu testenden System, in den Anfangszustand gebracht. Anschließend können im \textit{Exercise}-Schritt die zu testenden
	...
	ebenfalls am zu testenden System vorbei. Abschließend kann der vierte Schritt, \textit{Teardown}, noch Aufräumarbeiten
	durchführen. Abbildung \ref{img:backdoormanipulation} stellt Back Door Manipulation grafisch dar.
