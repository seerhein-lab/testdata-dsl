...
\textit{Apache-Torque}-Modells vorliegt) oder manuell geschehen. Das \textit{STU}-Modell enthält Informationen zu Tabellennamen
...
Das \textit{STU}-Modell enthält keine Datenbank-Constraints. Eine Abbildung dieser würde keine wesentlichen Vorteile bringen. Das API
