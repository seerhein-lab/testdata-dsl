...
\todo{Konventionen einleiten}
  ...
  \subsection{ER-Diagramme}
	...
	Alle in dieser Arbeit abgebildeten relationalen Datenbank-Diagramme verwenden einen einheitlichen Modellierungsstil,
	der auch von Ambler in Ambler in \cite{REFACTORING_DATABASES} verwendet wird. Dieser Stil erweitert das dem UML-konform
	das Klassendiagramm.
