...
\textit{STU} ist eine Bibliothek zur Vereinfachung von Unit-Tests für Java-basierte Anwendungen. \textit{STU} steht unter der 
\textit{Apache License 2.0} \cite{APACHE_LICENSE_2} und wird maßgeblich von der Firma SEITENBAU entwickelt. Diese Arbeit
thematisiert nur den Teil von \textit{STU}, der Tests von Datenbank-Anwendungen vereinfachen soll.
\todo{Apache License 2 kurz beschreiben}
...
\textit{DbUnit} DataSets in die Datenbank einspielen. \todo{Kurz erklären, was ein DataSet ist} Außerdem kann DbUnit den Inhalt 
...
\todo{Nachteile von DbUnit-DataSets - vorwegnehmen ?}
...
\begin{itemize}
	...
	\item \textbf{FindWhere}: Für einfache Suchanfragen gibt es für jede Tabelle die innere Klasse \texttt{FindWhere}. Sie ermöglicht
	  die Suche nach  einem Wert in einer Spalte und liefert eine Liste von Tabellenzeilen. Die Methode ist zur Suche nach Zeilen
		vorgesehen, von denen erwartet wird, dass es sie gibt. 
