...
mit Java-Anwendungen. 
	...
	\nomenclature{AST}{Abstract Syntax Tree}
		...
		enthält dafür die Methode \textit{parseTableClosure}.
		...
		beteiligten Operanden als Parameter. Eine solche Methode wird als Kateoriemethode bezeichnet. 
		...
		können die Kateogiemethoden in einem Closure verwendet werden. \cite[192]{GROOVY_IM_EINSATZ} 
		
		Listing \ref{listing:opoverloading.tableparser} zeigt das Grundgerüst des Tabellenparsers:
		
	\begin{lstlisting}[caption=Tabellen-Parser mit Operator-Überladen, label=listing:opoverloading.tableparser]
class TableParser {
...
\end{lstlisting}
		...
		- Categories zum "`Einblenden"' von Methoden
