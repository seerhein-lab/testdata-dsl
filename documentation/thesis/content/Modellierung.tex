...
Erklären:
\begin{itemize}
  \item DSL zusätzliche Schicht über bisherigen Klassen (allerdings sind auch Erweiterungen wie Lazy Values im alten Framework)
  \item Allgemeine Parser-Klasse, Callback-Klasse
	\item ScopeRegistry und Scopes
	\item Referenzen (getter, Methoden für Beziehungen)
	\item ColumnBinding
	\item getWhere
	\item Decorator für RowBuilder
	\item Verbessertes findWhare
	\item getWhere
	\item find
	\item foreach
	\item Lazy Values
