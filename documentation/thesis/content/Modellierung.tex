...
Mit Hilfe dieser Analyse wird die finale Modellierungssprache definiert. Bei den Bewertungskriterien wird auf den
...
...
  ...
  Variablennamen für die Modellierung von Beziehungen. Für diesen Entwurf sieht die Bewertung folgendermaßen aus:
	...
	\begin{itemize}
		...
		\item \textbf{Benutzbarkeit (Verständlichkeit und Erlernbarkeit)}:
		  Der Entwurf ist verständlich und leicht zu erlernen, da sich die meisten Sprachelemente auf das Datenbank-Schema
			...
			Die Beschreibung der Beziehungen abseits der Definition der Daten kann den
...
...
  ...
  überblickt werden. Die tabellarische Schreibweise wird für die Zielgruppe vertraut wirken und intuitiver
...
class TableParser {
  ...
  def parseTableClosure(Closure tableData){
    ...
    Die statischen \texttt{or}-Methoden haben keinen Zugriff auf Instanz-Variablen der Klasse \texttt{TableParser}. 
		Ihre Zwischenergebnisse, also die geparsten Spaltenwerte, können sie demnach auch nur in statische Elementen
		aufbewahren. Um die Klasse Thread-sicher zu machen, d.h. das Erlauben von gleichzeitigem Parsen von Tabellen
		aus verschiedenen Threads heraus, wird für die Ergebnisse eine threadlokale Liste verwendet.
