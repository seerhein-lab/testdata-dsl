...
\url{https://github.com/Seitenbau/stu}) verwendet. \textit{STU} steht unter der Open-Source-Lizenz Apache ... 
\todo{Welche Lizenz?}
...
\begin{itemize}
	\item Das \textbf{Fluent Builder API} ist ein \textbf{Java}-basiertes API. Es basiert auf \textit{SB Testing DB} und ist
	  zu diesem abwärtskompatibel. Der Name spiegelt wieder, dass ein Fluent-Java-API verwendet wird (siehe auch Abschnitt 
		\ref{sec:grundlagen:sbtestingdb}).
