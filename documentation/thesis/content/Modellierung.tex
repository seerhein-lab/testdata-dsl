...
...
  ...
  \todo{Sprache gemäß Kriterien bewerten}	
	\begin{itemize}
		...
		\item \textbf{Zeilen}: Für die Modellierung der Beispieldaten werden 63 Zeilen benötigt. Für jeden Spaltenwert und
		...
		\item \textbf{Benutzbarkeit (Verständlichkeit und Erlernbarkeit)}: 
			...
			Die Beschreibung der Beziehungen abseits der Definition der Daten
...
...
  ...
  \todo{Sprache gemäß Kriterien bewerten}	
	\begin{itemize}
		...
		\item \textbf{Zeilen}: 62
		
		\item \textbf{Zeichen pro Zeile}: 50
  ...
  \label{sec:implementierung:entwurf:3}
	...
	\todo{Beispiel-Entwürfe benennen ?}
