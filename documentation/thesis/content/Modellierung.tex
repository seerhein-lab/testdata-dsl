...
class HochschuleDataSet extends HochschuleBuilder
{
  ...
  def tables() {
    ...
    studentTable.rows {
      REF        | matrikelnummer | name         | vorname    | studieng...
  ...
  def relations() {
	...
	Aufgrund der eingeschränkten Seitenbreite ist die Tabelle mit den Studenten in zwei Blöcke aufgeteilt.
	Die Darstellung ist sehr übersichtlich.
	
	\subsection{Nutzung des DataSets in einem Java-Test}
	\label{sec:modellierung:realisierung:javatest}
