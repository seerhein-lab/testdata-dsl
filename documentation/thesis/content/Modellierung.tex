...
Relations   = {", NewLine, { Relation, NewLine }, "}"
...
WAESCH.beaufsichtigt(P_VSYS)
	...
	\todo{Future erklären bei der Rule}
...
\end{figure}
  ...
  Fehler in der eigentlichen Tabellenstruktur, z.B. eine abweichende Anzahl von Spalten, kann der Standard-Compiler
	nicht erkennen, genauso wie ungültige Spaltenwerte bzw. ungültige Typen. Solche Fehler werden in der gegenwärtigen
	Implementierung zur Laufzeit erkannt und führen zum Scheitern der Tests.
	
	Die geworfene Ausnahme versucht dem Entwickler dabei zu helfen, die Fehlerstelle zu lokalisieren.
	Einige können direkt
	durch den Compiler erkannt werden, z.B. bei Tabellen- und Spalten-Namen.
