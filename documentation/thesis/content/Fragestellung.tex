...
dataSet.addTable(lehrveranstaltung);
  \end{lstlisting}
	...
	\begin{itemize}
		...
		\item \textbf{Benutzbarkeit (Verständlichkeit und Erlernbarkeit)}: 
		  Der Code ist zwar nicht unbedingt intuitiv, aber überschaubar und für einen Java-Programmierer auch leicht erlernbar.
			Die Verständlichkeit leidet unter den selben Problemen wie die \texttt{XmlDataSets}: Daten werden einfach in Form
			...
			das Zuweisen eines Fremdschlüssels auf den Primärschlüssels einer falschen Tabelle.
		...
		\item \textbf{Modifizierbarkeit}:
		  Das Anpassen des DataSets an neue Datenbank-Schemen kann relativ umständlich werden, wenn Spalten hinzukommen oder
			...
			IDE-Rafactoring-Unterstützung einfach durchgeführt werden, z.B. das Ändern von Bezeichnern für Konstanten.
	...
	erzeugt werden können, z.B. ein DataSet mit dem Ausgangszustand und ein DataSet mit dem erwarten
