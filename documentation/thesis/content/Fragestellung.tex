...
\begin{itemize}
	...
	\item \textbf{Fokus auf Beziehungen}: 
	  \todo{Fokus auf Beziehungen ergänzen}
	
	\item \textbf{Datenmenge selbst bestimmen}:
	  \todo{Datenmenge selbst bestimmen ergänzen}
...
\label{sec:fragestellung:modellierung}
	...
	\begin{itemize}
		...
		\item \textbf{Redundanz}:
		  \todo{Kriterium: Redundanz}

		\item \textbf{Benutzbarkeit (Verständlichkeit und Erlernbarkeit)}:
		  \todo{Kriterium: Benutzbarkeit}
		
		\item \textbf{Modifizierbarkeit}:
		  \todo{Kriterium: Modifizierbarkeit}
			- Wie leicht lassen sich Daten ändern
			- Wie leicht lassen sich Daten an ein neues Schema anpassen?
...
\todo{Sprachen gemäß Kriterien bewerten}	
