...
Da die Modellierung der Testdaten mit DbUnit-eigenen Mitteln einige Nachteile hat, hat
...
dataSet.addTable(lehrveranstaltung);
  ...
  Art nur wenig Vorteile gegenüber den XML-Datasets.
	...
	Die Bibliothek SB Testing DB der Firma \textit{Seitenbau GmbH} versucht Nachteile der XML- und
