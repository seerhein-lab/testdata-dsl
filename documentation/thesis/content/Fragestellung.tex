...
\begin{itemize}
	\item \textbf{Kompatiblität}: Die Generierung der Testdaten soll nicht nur bei Nutzung der neuen Modellierungssprache
	  verwendet werden können. Stattdessen sollte der Testdaten-Generator auch DataSets auf Basis der bisherigen SB-Testing-DB-Builder
		erstellen können.
\end{itemize}
...
\label{sec:fragestellung:modellierung}
	...
	BLOBs lassen sich bei den meisten Modellierungsvarianten nur mit eigenem Aufwand realisieren. Eine direkte Darstellung
	...
	Weise zur Laufzeit erzeugt werden (Einlesen aus Datei, Generierung, ...).
