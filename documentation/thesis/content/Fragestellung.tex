...
die Erweiterung \textit{DbUnit}. Zwar erlaubt die verwendete Bibliothek SB Testing DB (siehe \ref{sec:grundlagen:sbtestingdb})
eine einfachere Modellierung als mit DbUnit-eigenen Mitteln, 
