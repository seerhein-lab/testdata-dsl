...
für die Aufgabenstellung nutzen lassen, soll im folgenden kurz analysiert werden.
  ...
  Test-Daten zu reduzieren. Eine Äquivalenzklasse fasst Eingangsdaten zusammen, für die das Verhalten des SUT das selbe
	...
	auf \cite[125]{BASISWISSEN_SOFTWAETEST}. Im Falle zu generierender Beziehungen sollten die Grenzfälle die minimale und
	die maximale Beziehungsmöglichkeiten abdecken.
...
\end{lstlisting}
    ...
    Die Funktion zum Generieren von Daten für eine Kante setzt die 
...
\end{lstlisting}
    ...
    Ungültig bedeutet, dass sie bei einer oder mehrere Kanten nicht in ausreichend vielen Beziehungen steht.
    ...
    Unter Umständen würde dieser Algorithmus nie terminieren, weshalb eine Abbruch-Bedingung sinnvoll ist.
		Diese wird nicht im Pseudo-Code (Listing \ref{listing:ErweitereGenerierteDatenZuKonsistentenDaten}) dargestellt.
