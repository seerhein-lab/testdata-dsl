...
Im Paper \cite{Houkjaer:2006:SRD:1182635.1164254} wird ein Algorithmus zur Generierung von Test-Daten vorgestellt, der
...
Die Beschreibung des Algorithmus verwendet einige Begriffe und Konventionen, die im Folgenden beschrieben werden.
  ...
  \label{sec:generieren:algorithmus:pseudocode}
		...
		Die Funktion Generiere\_Test\_Daten ist der Einstiegspunkt für den Algorithmus zur Generierung von Test-Daten.
		...
		Paper \cite{Houkjaer:2006:SRD:1182635.1164254}.
...
\end{lstlisting}
		...
		\subsubsection{Generiere Daten Fuer Nichtassoziative Tabelle}
...
\end{lstlisting}
		...
		\subsubsection{Generiere Daten Fuer Kante}
...
\section{Praktischer Einsatz / Evaluation}
  ...
  \subsection{Einfluss der Tabellenreihenfolge}
	...
	Die Art und Weise, wie Beziehungen modelliert werden, hängen von der Reihenfolge ab, in der die Tabellen und Kanten behandelt
	werden. Die gewählte Reihenfolge basiert auf den Kriterien aus dem Paper \cite{Houkjaer:2006:SRD:1182635.1164254}. Die Sortierung
...
Die Zufallszahlengeneratoren der Werte-Generatoren werden über Seeds festgelegt. Damit der selbe Werte-Generator für verschiedene
...
0 haben. Das tatsächliche Seed, mit dem die Zufallsgeneratoren initialisiert werden, stellt somit die Summe aus dem Spalten-Seed,
dem Tabellen-Seed und dem Modell-Seed dar.

Auf diese Weise kann über Seeds verhältnismäßig einfach gesteuert werden, dass nur eine Spalte mit neuen Zufallszahlen initialisiert wird, 
alle Spalten einer Tabelle oder alle Spalte aller Tabellen. Es ist darüber hinaus auch möglich, zwei Spalten mit selben Zufallswerten
zu erzwingen.
