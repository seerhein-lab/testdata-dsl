...
Die Abbildungen stellen dar, welche Entitäten \textit{mindestens} generiert werden sollten.
  ...
  \subsection{Kategorie der n:m-Beziehungen}
	...
	(siehe dazu Abbildungen \ref{img:generierung:1to0} und \ref{img:generierung:3to0}).
...
\end{lstlisting}
		...
		- Grafik zur Verdeutlichung des Tauschs
		
	  \begin{figure}[htbp]
  	  \centering
  	   \includegraphics[width=0.55\textwidth]{images/generierung/tausch-at.png}
  	  \caption{Tausch}\label{img:generierung:tauschat}
  	\end{figure}
