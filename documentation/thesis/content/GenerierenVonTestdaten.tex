...
\begin{enumerate}
  ...
  \item \textbf{Abfrage-basierte Generierung}:
  	...
  	\cite{DBLP:conf:icde:BinnigKL07} einen Ansatz, in dem SQL-Abfragen als Grundlage für die Daten-Generierung verwendet
		werden.
...
Eigene Vorschläge, wie viele Daten generiert werden sollten, machen die Werkzeuge nicht.
	...
	in Widerspruch mit einer Massen-Daten-Generierung. Aus diesem Grund soll ein Algorithmus entwickelt werden, der
...
Die Abbildungen stellen dar, welche Entitäten und Beziehungen \textit{mindestens} generiert werden sollten.
\todo{Kurz Äquivalenzklassen/Grenzwertanalyse anmerken}
...
Bevor der Pseudocode des Algorithmus beschrieben wird, werden einige verwendete Begriffe beschrieben und das Klassen-Diagramm
des Modells vorgestellt, das der Daten-Generator verwendet.
...
DO
  ...
  END IF;
END FOR;
CALL Erweitere_Generierte_Daten_Zu_Konsistenen_Daten()
\end{lstlisting}
...
Erweitere_Generierte_Daten_Zu_Konsistenen_Daten()
-------------------------------------------------
\end{lstlisting}
  ...
  \subsection{Beispiel}
	...
	das vier Tabellen definiert (siehe Abbildung \ref{img:generierung:examplemodel}).
    ...
    Der Algorithmus befindet sich bei der Generierung bei TABLE1 (siehe Abbildung \ref{img:generierung:example:step_table1}).
		...
		Abbildung \ref{img:generierung:example:step_table2}
		...
		Abbildung \ref{img:generierung:example:step_tableat}
		...
		\begin{tabular}{l|l||l|l}
			...
			\hline
% 0..1:3			                  5:5			
			TABLE2\_1  &            & TABLE2\_13 & TABLE3\_8  \\
			TABLE2\_2  & TABLE3\_1  & TABLE2\_13 & TABLE3\_9  \\
			TABLE2\_3  & TABLE3\_1  & TABLE2\_13 & TABLE3\_10 \\
			TABLE2\_4  & TABLE3\_1  & TABLE2\_13 & TABLE3\_11 \\
% 0..1:5			
			TABLE2\_5  & TABLE3\_2  & TABLE2\_13 & TABLE3\_12 \\
			TABLE2\_6  & TABLE3\_2  & TABLE2\_14 & TABLE3\_8  \\
			TABLE2\_7  & TABLE3\_2  & TABLE2\_14 & TABLE3\_9  \\
			TABLE2\_8  & TABLE3\_2  & TABLE2\_14 & TABLE3\_10 \\
			TABLE2\_9  & TABLE3\_2  & TABLE2\_14 & TABLE3\_11 \\
% 5:3
			TABLE2\_10 & TABLE3\_3  & TABLE2\_14 & TABLE3\_12 \\
			TABLE2\_10 & TABLE3\_4  & TABLE2\_15 & TABLE3\_8  \\
			TABLE2\_10 & TABLE3\_5  & TABLE2\_15 & TABLE3\_9  \\
			TABLE2\_10 & TABLE3\_6  & TABLE2\_15 & TABLE3\_10 \\
			TABLE2\_10 & TABLE3\_7  & TABLE2\_15 & TABLE3\_11 \\
			TABLE2\_11 & TABLE3\_3  & TABLE2\_15 & TABLE3\_12 \\
			TABLE2\_11 & TABLE3\_4  & TABLE2\_16 & TABLE3\_8  \\
			TABLE2\_11 & TABLE3\_5  & TABLE2\_16 & TABLE3\_9  \\
			TABLE2\_11 & TABLE3\_6  & TABLE2\_16 & TABLE3\_10 \\
			TABLE2\_11 & TABLE3\_7  & TABLE2\_16 & TABLE3\_11 \\
			TABLE2\_12 & TABLE3\_3  & TABLE2\_16 & TABLE3\_12 \\
			TABLE2\_12 & TABLE3\_4  & TABLE2\_17 & TABLE3\_8  \\
			TABLE2\_12 & TABLE3\_5  & TABLE2\_17 & TABLE3\_9  \\
			TABLE2\_12 & TABLE3\_6  & TABLE2\_17 & TABLE3\_10 \\
			TABLE2\_12 & TABLE3\_7  & TABLE2\_17 & TABLE3\_11 \\
			           &            & TABLE2\_17 & TABLE3\_12 \\
			\hline
 			           &            & 17 Entitäten  & 12 Entitäten  \\
		 \end{tabular}
				
		\subsubsection{6. Schritt: Generierung für TABLE3}
			
		Abbildung \ref{img:generierung:example:step_table3}
